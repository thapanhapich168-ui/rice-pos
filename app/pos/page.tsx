...
export default function POSPage() {
  ...
  // 🔥 250ms Debounced Focus State (Stops modal from jumping between Qty -> Price!)
  ...
  // 🔥 ABSOLUTE IOS BACKGROUND SCROLL LOCK (Freezes main document when any modal is open)
  useEffect(() => {
  ...
  // 🔥 Key down handler so Enter key on keyboard moves to next input smoothly
  ...
  return (
    <div className={isModalInputFocused ? 'modal-keyboard-push' : ''} style={{ display: 'flex', width: '100%', height: '100dvh', overflow: 'hidden', backgroundColor: '#ffffff', boxSizing: 'border-box' }}>
      ...
      {/* 🔥 COMPACT VERTICAL MOBILE PRODUCT ADD POPUP WITH REGULAR KEYBOARD + NUMBER ROW */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px' }}>
          <div style={{ width: '100%' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #cbd5e1', borderRadius: '6px', padding: '2px 10px', background: '#ffffff' }}>
              {/* 🔥 Standard inputMode="text" allows "123" number row on top + blue Next button */}
              <input
                ref={mobileQtyRef}
                type="text"
                inputMode="text"
          ...
          <div style={{ width: '100%' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #cbd5e1', borderRadius: '6px', padding: '2px 10px', background: '#ffffff' }}>
              {/* 🔥 Standard inputMode="text" allows "123" number row on top + blue Done button */}
              <input
                ref={mobilePriceRef}
                type="text"
                inputMode="text"
      ...
      <style jsx global>{`
        ...
        /* 🔥 3. ZERO-BOUNCE KEYBOARD PUSH: Smoothly slides up 85px from center without reflows */
        @media (max-width: 1023px) {
          .modal-keyboard-push div[role="dialog"],
          .modal-keyboard-push div[class*="modal"]:not(.mobile-cart-overlay):not(.mobile-fab),
          .modal-keyboard-push div[class*="Modal"]:not(.mobile-cart-overlay):not(.mobile-fab),
