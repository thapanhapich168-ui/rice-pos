...
const [edits, setEdits] = useState<Record<number, Partial>>({})
const [selectedToDelete, setSelectedToDelete] = useState<Set>(new Set())
...
const [historyEdits, setHistoryEdits] = useState<Record<number, Partial>>({})

/* STREAMING_CHUNK:Loading data on mount... */
// --- LIFECYCLE ---
useEffect(() => {
fetchProducts()
fetchSettings()
...
/* STREAMING_CHUNK:Configuring Supplier and Import actions... */
...
/* STREAMING_CHUNK:Defining grid and product helpers... */
// --- RECORD OPERATIONS ---
...
/* STREAMING_CHUNK:Initializing drag and drop functionality... */
...
/* STREAMING_CHUNK:Filtering and processing data lists... */
// --- DATA PROCESSING ---
...
/* STREAMING_CHUNK:Rendering main component UI... */
return (
  ...
  /* STREAMING_CHUNK:Rendering Import Stock tab... */
  {/* IMPORT FORM TAB */}
  {activeView === 'import' && (
  ...
  /* STREAMING_CHUNK:Rendering Pending Payments tab... */
